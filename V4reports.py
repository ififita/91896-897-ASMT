'''This is the reports module for version 4 of the Student Gradebook Manager.
It imports student data and calculates averages.
It generates and displays a summary report of all students.
'''
from easygui import *
from V4students import students, calc_avg #Import the student data dictionary and average function
